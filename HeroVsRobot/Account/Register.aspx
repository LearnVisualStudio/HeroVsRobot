<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="HeroVsRobot.Account.Register" %>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="HeroNameTextbox"
                                    CssClass="text-danger" ErrorMessage="The hero's name is required." />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="EmailTextBox"
                                    CssClass="text-danger" ErrorMessage="An email address is required." />
                            </div>
                        </div>
